...
@NamedQueries({
    ...
    @NamedQuery(name = "Data.findByProgramstudi", query = "SELECT d FROM Data d WHERE d.programstudi = :programstudi"),
    @NamedQuery(name = "Data.findByFakultas", query = "SELECT d FROM Data d WHERE d.fakultas = :fakultas")})
public class Data implements Serializable {
    ...
    public String toString() {
        return "assessment_036.webservice.Data[ nim=" + nim + " ]";
    }
