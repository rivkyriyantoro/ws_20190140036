...
import assessment_036.webservice.exceptions.NonexistentEntityException;
import assessment_036.webservice.exceptions.PreexistingEntityException;
...
public class DataJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("assessment_036_webservice_jar_0.0.1-SNAPSHOTPU");
